...
plot "data/insert_string" using 2:xtic(1) with lines ls 1, \
    "data/insert_string" using 3:xtic(1) with lines ls 2, \
    "data/insert_string" using 4:xtic(1) with lines ls 3, \
    "data/insert_string" using 5:xtic(1) with lines ls 4, \
    "data/insert_string" using 6:xtic(1) with lines ls 5
